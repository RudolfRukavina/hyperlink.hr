...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery as getQuery$1, getRequestHost, getRequestProtocol, getRequestHeaders, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, createError, getResponseStatusText } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/devalue/index.js';
import { renderSSRHead } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withoutProtocol, withLeadingSlash, withBase, withTrailingSlash } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/radix3/dist/index.mjs';
import devalue from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, version, unref } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/vue/index.mjs';
import { defineHeadPlugin, tagDedupeKey, tagWeight, HasElementTags, hashCode, NetworkEvents, SortModifiers, processTemplateParams, resolveTitleTemplate, IsBrowser, normaliseEntryTags } from 'file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/node_modules/@unhead/shared/dist/index.mjs';
    ...
    "stack": [
      {
        "_context": "system",
        "_priority": -15,
        "name": "Hyperlink Presentation Taxi Hrvatska",
        "env": "development"
      },
      {
...
const serverAssets = [{"baseName":"server","dir":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/hexis/Work/Digitalna Hrvatska/Hyperlink Presentation Taxi Hrvatska/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _90lkyxJZ72 = (function(nitro) {
...
const _y60xXQPnGp = defineNitroPlugin(async (nitroApp) => {
...
const _jdy0Jz245R = defineNitroPlugin(async (nitroApp) => {
...
const _LgDibN = defineEventHandler(async (e) => {
...
const _u0yf1Y = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _WMNAAA = defineEventHandler(async (e) => {
...
const _EgSxJJ = defineEventHandler(async (e) => {
...
const _pTT6w0 = defineEventHandler(async (e) => {
...
const _FfQoJY = defineEventHandler(async (e) => {
  const nitro = useNitroApp();
...
const _kzjoN7 = defineEventHandler(async (e) => {
...
const _GA1jd3 = defineEventHandler(async (e) => {
...
const _qpOfhq = defineEventHandler(async (e) => {
...
const _j9l3iU = defineEventHandler(async (e) => {
...
const _6fv8LT = defineEventHandler(async (e) => {
...
const _lazy_MOtYoJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_MOtYoJ, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _LgDibN, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _u0yf1Y, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _WMNAAA, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _EgSxJJ, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _pTT6w0, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _FfQoJY, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _kzjoN7, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _GA1jd3, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _qpOfhq, lazy: false, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _j9l3iU, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _6fv8LT, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_MOtYoJ, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"link":[{"rel":"icon","type":"image/x-con","href":"./public/favicon.ico"}],"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///Users/hexis/Work/Digitalna%20Hrvatska/Hyperlink%20Presentation%20Taxi%20Hrvatska/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
