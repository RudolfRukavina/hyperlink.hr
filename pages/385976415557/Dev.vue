<template>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
        ...
        <button data-collapse-toggle="navbar-language" type="button"
          class="inline-flex items-center p-2 w-10 h-10 bg-black justify-center text-sm text-white rounded-lg md:hidden hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
        <ul
          ...
          <li>
            <a href="#"
              class="block py-2 px-3 md:p-0 text-gray-100 rounded hover:bg-white hover:text-black md:hover:bg-transparent md:hover:underline underline-offset-2 md:hover:text-white ">Gallery</a>
          </li>
          <li>
            <a href="#"
              class="block py-2 px-3 md:p-0 text-gray-100 rounded hover:bg-white hover:text-black md:hover:bg-transparent md:hover:underline underline-offset-2 md:hover:text-white ">Reservations</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="-mt-20">
    <div class="w-full bg-center bg-cover"
      ...
      <div class="flex items-center justify-center w-full h-full bg-transparent py-24">
        <div class="text-center">
          <div class="container px-4 mx-auto">
            <div class="max-w-7xl mx-auto text-center">
              <a href="tel:+385 97 641 5557"
                class="text-yellow-300 ms-3 font-semibold uppercase underline text-2xl lg:text-3xl tracking-widest">+385
                97 641
                5557</a>
              <div
                  ...
                  <svg class="w-16 h-16" viewBox="0 -0.5 25 25" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        stroke="none" stroke-width="1.175" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path
  ...
  <main>
    ...
    <footer class="bg-black lg:grid lg:grid-cols-5">
              ...
              <div class="flex">
                <div
                  ...
                  <div class="flex justify-between cursor-pointer">
                    <p class="text-4xl tracking-tight font-medium text-white text-start md:text-5xl">
                      {{ taxiName }}
                    </p>
                  </div>
                  ...
                  <p class="text-base text-start font-medium text-gray-200">
                    <span class="text-xl">{{ ratings }}</span> global ratings
                  </p>
                  <div class="flex items-center mt-4">
                    <a href="#" class="text-base font-medium text-gray-300 hover:underline">5
                      star</a>
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                      <div class="h-5 bg-yellow-300 rounded" style="width: 100%"></div>
                    </div>
                    <span class="text-base font-medium text-gray-200">100%</span>
                  </div>
                  <div class="flex items-center mt-4">
                    <a href="#" class="text-sm font-medium text-gray-300 hover:underline">4 star</a>
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                      <div class="h-5 bg-yellow-300 rounded" style="width: 0%"></div>
                    </div>
                    <span class="text-sm font-medium text-gray-200">0%</span>
                  </div>
                  <div class="flex items-center mt-4">
                    <a href="#" class="text-sm font-medium text-gray-300 hover:underline">3 star</a>
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                      <div class="h-5 bg-yellow-300 rounded" style="width: 0%"></div>
                    </div>
                    <span class="text-sm font-medium text-gray-200">0%</span>
                  ...
                  <div class="flex items-center mt-4">
                    <a href="#" class="text-sm font-medium text-gray-300 hover:underline">2 star</a>
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                      <div class="h-5 bg-yellow-300 rounded" style="width: 0%"></div>
                    </div>
                    <span class="text-sm font-medium text-gray-200">0%</span>
                  ...
                  <div class="flex items-center mt-4">
                    <a href="#" class="text-sm font-medium text-gray-300 hover:underline">1 star</a>
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-gray-700">
                      <div class="h-5 bg-yellow-300 rounded" style="width: 0%"></div>
                    </div>
                    <span class="text-sm font-medium text-gray-200">0%</span>
      ...
      <div class="px-10 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <p>
              <span class="text-base uppercase tracking-wide text-gray-100">
                Call us
              </span>

              <a href="#"
                class="block text-2xl font-medium text-yellow-300 undeline underline-offset-2 hover:opacity-75 sm:text-3xl dark:text-white">
                +385 97 641 5557
              </a>
            </p>

            <ul class="mt-8 space-y-1 text-3xl text-gray-200">
              <li>0 - 24</li>
              <li>We are open every day!</li>
            </ul>

            <p class="font-semibold mt-5 text-2xl text-white">Pratite nas</p>
        ...
        <div class="mt-12 border-t border-gray-100 pt-4 dark:border-gray-800">
          <div class="sm:flex sm:items-center sm:justify-center">

            <p class="mt-8 text-base text-center text-white sm:mt-0">
              &copy; 2024. Obrt za cestovni prijevoz M.T. <br /> All rights reserved. <br />
              <span class="font-bold mt-2 underline underline-offset-2">Obavijest o zaštiti privatnosti i GDPR-u.</span>
            </p>
          </div>
        </div>
      </div>
