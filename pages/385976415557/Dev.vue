<template>
  ...
  <header class="-mt-20">
    <div class="w-full bg-center bg-cover"
          ...
          <div class="container px-4 mx-auto">
            <div class="max-w-4xl mx-auto text-center">
              <a href="tel:+385 97 641 5557"
                class="text-gray-200 font-semibold uppercase underline text-3xl lg:text-4xl tracking-widest">+385
                97 641
                5557</a>

              <div class="mx-auto max-w-2xl">
                <p class="text-xl text-white mb-5">0 - 24</p>
                <div class="text-center">
                  <h1 class="text-xl leading-none tracking-tight text-white drop-shadow-md">
                    <strong>info@taxivrsar.hr</strong>
                  </h1>
      ...
      <section class="bg-black bg-opacity-50 pt-10 backdrop-blur-[1px]">
      ...
      <div class="col-span-1 lg:col-span-1">
        <NuxtLink class="portfolio-item block relative" to="/ostalo">
          <div class=" absolute inset-0 bg-black bg-opacity-50 transition-opacity lg:opacity-0 hover:opacity-100">
            <div class="caption absolute inset-0 flex items-center justify-center">
              <div class="text-white text-center">
                <div class="text-2xl">Taxi usluga
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="col-span-1 lg:col-span-1">
        <NuxtLink class="portfolio-item block relative" to="/najamkombivozila">
          ...
          <img class="object-cover w-full h-full"
            src="https://lanterna-taxi-porec.com/wp-content/uploads/2023/03/taxi-transfer-porec-2-900x600.jpg"
            alt="..." />
        </NuxtLink>
      </div>
      <div class="col-span-1 lg:col-span-1">
        <NuxtLink class="portfolio-item block relative" to="/najamautomobila">
          ...
          <img class="object-cover w-full h-full"
            src="https://lanterna-taxi-porec.com/wp-content/uploads/2023/03/taxi-transfer-porec-1-900x600.jpg"
            alt="..." />
        </NuxtLink>
      </div>
      <div class="col-span-1 lg:col-span-1">
        <NuxtLink class="portfolio-item block relative" to="/ostalo">
          ...
          <img class="object-cover w-full h-full"
            src="https://lanterna-taxi-porec.com/wp-content/uploads/2023/03/taxi-transfer-porec-4-900x600.jpg"
            alt="..." />
        </NuxtLink>
      </div>
      <div class="col-span-1 lg:col-span-1">
        <NuxtLink class="portfolio-item block relative" to="/ostalo">
          ...
          <img class="object-cover w-full h-full"
            src="https://lanterna-taxi-porec.com/wp-content/uploads/2023/03/taxi-transfer-porec-5-1-900x600.jpg"
            alt="..." />
        </NuxtLink>
      </div>
    </div>
    ...
    <div class="mx-auto px-8">
      <div class="w-full flex flex-col md:flex-row py-6">
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <NuxtLink to="/" class="no-underline hover:underline text-gray-800 hover:text-blue-500">{{ $t("terms") }}
              </NuxtLink>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <NuxtLink to="/" class="no-underline hover:underline text-gray-800 hover:text-blue-500">{{ $t("privacy")
                }}
              </NuxtLink>
            </li>
          </ul>
